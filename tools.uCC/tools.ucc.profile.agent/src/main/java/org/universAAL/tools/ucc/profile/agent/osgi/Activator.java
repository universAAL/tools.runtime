package org.universAAL.tools.ucc.profile.agent.osgi;
...
import org.universAAL.tools.ucc.profile.agent.impl.ProfileAgentImpl;
...
public class Activator implements BundleActivator {
	...
	private void testSpaceServer() {
		...
		/** This does not work !!!! **/
		/*
		 * System.out.println("[TEST] getting devices of space..." +
		 * space.getURI()); System.out.println("Result is: " +
		 * agent.getDevicesOfSpace(space));
		 */
	...
	public void test() {
		...
		/*
		 * System.out.println("[TEST] getting user profile with ID..." +
		 * userID); System.out.println("Result is: " +
		 * agent.getUserProfile(userID));
		 */
		...
		/*
		 * System.out.println("[TEST] deleting an user: " + userURI); boolean
		 ...
		 * System.out.println("Add userId subprofile: " +
		 * agent.addSubProfile(userIDProfile));
		 * System.out.println("Add subprofile to user Maria. " +
		 ...
		 * //System.out.println("Add userId subprofile: " +
		 * agent.addSubProfile(healthProfile));
		 * //System.out.println("Add health subprofile to user Maria. " +
		 ...
		 * ((UserIDProfile)gotUserIdProfile).getUSERNAME());
		 * System.out.println("the password: " +
		 * ((UserIDProfile)gotUserIdProfile).getPASSWORD()); } }
		 */
		...
		// System.out.println("Result is: " +
		// agent.addUserSubprofile(userProfile, healthProfile)); */

		// has some problem when installing the profile agent if running the
		// following code
		/*
		 * System.out.println("[TEST] getting user subprofiles...");
		 * log.info("[TEST] getting user subprofiles..."); List
		 * gotUserIdProfile2 = agent.getUserSubprofiles(userProfile); if
		 * (gotUserIdProfile2==null) log.info("[TEST] the result is null"); else
		 * { log.info("[TEST] gotten user subprofiles:" +
