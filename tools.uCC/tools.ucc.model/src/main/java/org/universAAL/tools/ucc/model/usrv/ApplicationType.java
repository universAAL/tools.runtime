...
/**
 * describes the software part, where the artifactID is the one set by the
 * developer in his application description (in the xml part of the uapp file)
 * 
 * <p>
...
@XmlType(name = "applicationType", namespace = "http://www.universaal.org/aal-usrv/v1.0.2", propOrder = { "name",
		"version", "clazz", "artifactID", "location" })
