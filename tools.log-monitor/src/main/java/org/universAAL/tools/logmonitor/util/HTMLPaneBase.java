...
public class HTMLPaneBase extends JTextPane {
	...
	protected String getImageHTML(String name) {
		...
		urlReplacement.put(url.toString(), "http://depot.universaal.org/images/LogMonitor/" + name);
	...
	protected String getTableStartHTML(int border) {
		return "<table border=\"0\"><tr><td width=\"20\"></td><td>" + "<table valign=\"top\" border=\"" + border
				+ "\">\n";
	}
	...
	protected String getTableRowHTML(String val1, int colspan) {
		return "<tr><td colspan=\"" + colspan + "\" bgcolor=\"#EEEEEE\">" + val1 + "</td></tr>\n";
	}
